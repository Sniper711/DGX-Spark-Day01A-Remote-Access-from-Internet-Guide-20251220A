...
- [9. Mac/PC (Client) 登入/命令 DGX Spark (Server)](#9-macpc-client-登入命令-dgx-spark-server)
  - [9.1 SSH 從 Mac/PC (Client) 登入 DGX Spark (Server) ](#91-ssh-從-macpc-client-登入-dgx-spark-server)
  - [9.2 兩種範例方法 用 Mac/PC (Client) 命令 DGX Spark (Server)](#92-兩種範例方法-用-macpc-client-命令-dgx-spark-server)
