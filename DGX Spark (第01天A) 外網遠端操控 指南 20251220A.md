...
- [8. Mac/PC (Client) 從外網 VPN 連回家裡的 Server (DGX Spark)](#8-macpc-client-從外網-vpn-連回家裡的-server-dgx-spark)
...
- [9. Mac/PC (Client) 登入/控制 DGX Spark (Server)](#9-macpc-client-登入控制-dgx-spark-server)
  - [9.1 SSH 從 Mac/PC (Client) 登入 DGX Spark (Server) ](#91-ssh-從-macpc-client-登入-dgx-spark-server)
...
## 9. Mac/PC (Client) 登入/命令 DGX Spark (Server) 

### 9.1 SSH 從 Mac/PC (Client) 登入 DGX Spark (Server)
...
### 9.2 兩種範例方法 用 Mac/PC (Client) 命令 DGX Spark (Server)
